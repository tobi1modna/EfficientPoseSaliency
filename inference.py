...
def main():
    ...
    #input parameter
    path_to_images = "/home/tobi/aipert/EP/hotstabs/data/01/rgb/"
    image_extension = ".png"
    phi = 0
    path_to_weights = "/home/tobi/aipert/EP/Weights/Linemod/object_9/phi_0_linemod_best_ADD.h5"
